...
class CreatePatientMiddleware implements MiddlewareInterface{
    public function process(ServerRequestInterface $rq, RequestHandlerInterface $rh) : Response{
        ...
        $required = ['password' => 'string', 'nom' => 'string', 'prenom' => 'string', 'dateNaissance' => 'string', 'email' => 'string', 'telephone' => 'string'];
        ...
        $dto = new InputPatientDTO($data);
        $rq = $rq->withAttribute('inputPatient', $dto);
        return $rh->handle($rq);
    }
}